...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_turnout:
        ...
        countyvote = county_turnout.get(county_name)
        ...
        print(county_result)
         ...
         # NOT WORKING
         # Comment out Line101(6d) and add 
         # with open(file_to_save, "w") as txt_file: 
         # Then indent the if block below??
         # 6f: Write a decision statement to determine the winning county and get its vote count.
        if (countyvote > county_mostvotes):
            county_mostvotes = countyvote
